...
IF(CAST(Dues1112 AS NUMERIC(10,2)) >= 25.00, 'MEMBERSHIP_RENEW', 'MEMBERSHIP_NEW'),
Dues1112,
'CHECK',
@virgil,
Comments1112,
...
IF(CAST(Dues1213 AS NUMERIC(10,2)) >= 25.00, 'MEMBERSHIP_RENEW', 'MEMBERSHIP_NEW'),
Dues1213,
'CHECK',
@virgil,
Comments1213,
...
IF(CAST(Dues1314 AS NUMERIC(10,2)) >= 25.00, 'MEMBERSHIP_RENEW', 'MEMBERSHIP_NEW'),
Dues1314,
'CHECK',
@virgil,
Comments1314,
...
IF(CAST(Dues1415 AS NUMERIC(10,2)) >= 25.00, 'MEMBERSHIP_RENEW', 'MEMBERSHIP_NEW'),
Dues1415,
'CHECK',
@virgil,
Comments1415,
...
IF(CAST(Dues1516 AS NUMERIC(10,2)) >= 25.00, 'MEMBERSHIP_RENEW', 'MEMBERSHIP_NEW'),
Dues1516,
'CHECK',
@virgil,
Comments1516,
